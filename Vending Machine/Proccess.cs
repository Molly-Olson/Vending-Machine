...
//Molly was here
using System.IO;
//is any of this below needed now that I am not trying to use ILogger?
...
namespace Vending_Machine
{
    ...
    public static class Proccess
    {
        ...
        {
            public int _sodasInvocationCount = 0;
            public int _ChipsInvocationCount = 0;
            public int _CandyInvocationCount = 0;
            public void sodasTrackedFunction()
            {
                _sodasInvocationCount++;
                _ChipsInvocationCount++;
                _CandyInvocationCount++;
                Console.WriteLine($"Current Items Vended: {_sodasInvocationCount}, {_ChipsInvocationCount}, {_CandyInvocationCount} time(s). Thank you!");
            }
        }
